...
import com.yss.config.GeneratorStrategy;
...
public class SpringBootPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        // 设置基本信息
        generatorProperties
                .setMavenModuleName("collegeinteract")
                .setParentPackage("com.zf.interact")
                .setModuleName("interactAction")
                .setAuthor("yss")
                .setFileOverride(true);

        // 设置表信息
        generatorProperties.addTable("interact_action","id");
        // 设置表前缀
        ...
        generatorProperties.getDataSourceConfig()
                ...
                .setUrl("jdbc:mysql://localhost:3306/utils?useUnicode=true&characterEncoding=UTF-8&useSSL=false");
