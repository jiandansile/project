...
import com.yss.config.*;
import com.yss.config.query.SpringBootPlusMySqlQuery;
import com.yss.config.query.SpringBootPlusSqlServerQuery;
import com.yss.constant.GeneratorConstant;
import com.yss.exception.GeneratorException;
import com.yss.properties.GeneratorProperties;
import lombok.Data;
...
public class CodeGenerator {
    ...
    public void generator(String tableName, String pkIdName, GeneratorProperties generatorProperties) {
        ...
        if (StringUtils.isBlank(outputDir)) {
            ...
            // outputDir = rootProjectFile + File.separator + "zf-boot" + File.separator + mavenModuleName;
            outputDir = rootProjectFile + File.separator + File.separator + mavenModuleName;
        }
